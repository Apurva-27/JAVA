...
public class bank_transaction_mini {
	...
	public static void accountNotFound(int flag)
	{
		
		try
		{
		if(flag==1)
			throw new AccountNotFoundException("you are entered account number does not exist");
